...
def test_fix_message_pipe_delimited_parsing():
    raw_pipe = (
        "8=FIX.4.2|9=65|35=0|49=SERVER|56=CLIENT|34=2|52=20260315-12:00:00.000|10=128|"
    )
...
def test_fix_session_order_creation():
    ...
    order_msg = session.create_new_order_single(
        cl_ord_id="CL001", symbol="MSFT", side="1", qty=50.0, ord_type="2", price=420.50
    )
...
def test_fix_session_order_cancel():
    ...
    cancel_msg = session.create_order_cancel(
        cl_ord_id="CX001", orig_cl_ord_id="CL001", symbol="MSFT", side="1"
    )
